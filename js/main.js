...
// Couting the numerical values from 0 to given number in fun-fact-section
document.addEventListener("DOMContentLoaded", () => {
    const counters = document.querySelectorAll('.fun-facts-item h2');
    const speed = 500; // Adjust the speed of the counting effect
